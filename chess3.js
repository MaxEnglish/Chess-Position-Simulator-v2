...
class Chess3 {
    ...
    updateIterativeMoves (piece) {
        ...
        const iterate = (x, y, xOp, yOp, xray = false) => {
            ...
            } else if (nextSquare?.color === piece.color && !xray) {
...
class Piece {
    ...
    setHasCoords (coord1, coord2) {
        return this.updateEveryCycle ||  this.updateNextCycle || this.availableSquares.has(coord1) || this.blockedSquares.has(coord1) || this.availableSquares.has(coord2) || this.blockedSquares.has(coord2)
    }
}